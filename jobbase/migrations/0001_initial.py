# Generated by Django 4.1.2 on 2023-01-02 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.CharField(default='None', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobbase.jobpost')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cv', models.FileField(default=None, upload_to='cvfolder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobbase.profileseeker')),
                ('cv', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jobbase.cv')),
                ('jobpost', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobbase.jobpost')),
            ],
        ),
    ]
